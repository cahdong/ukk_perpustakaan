                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="post">
                                            <div class="form-floating mb-3">
                                                <input class="form-control" required  type="text" required name="nama" placeholder="Masukan nama lengkap"/>
                                            ...
                                            <div class="form-floating mb-3">
                                              ...
                                              <div class="form-group">
                                                ...
                                                <label class="small-mb-1">Alamat</label>
                                                 <textarea name="alamat" rows="2" class="form-control py-4"></textarea>
                                            <div class="form-floating mb-3">
